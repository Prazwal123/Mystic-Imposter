...
import { getAllCategories } from '@/game/data/wordlist';
import { getStatistics, getCustomPacks, saveCustomPack, deleteCustomPack, verifyAdminPassword, isAdminAuthenticated, setAdminAuthenticated, clearAdminAuth } from '@/game/lib/storage';
import { playButtonClick, playError } from '@/game/lib/sounds';
import { ArrowLeft, Lock, Eye, Trash2, Upload, FileSpreadsheet, Shield, AlertTriangle } from 'lucide-react';
import type { WordEntry } from '@/game/types/game';
