...
import { getSettings, saveSettings, resetStatistics, clearGameHistory, clearRecentWords } from '@/game/lib/storage';
import { playButtonClick } from '@/game/lib/sounds';
import type { AppSettings } from '@/game/types/game';
