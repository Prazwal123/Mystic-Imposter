...
import type { GameAction } from '@/game/context/GameContext';
import type { GameSettings, Player } from '@/game/types/game';
import type { ConnectionStatus, OnlineErrorPayload, OnlineRoomSnapshot } from '@/game/types/online';
import { getStoredPlayerToken, removeStoredPlayerToken, storePlayerToken } from '@/game/lib/onlineIdentity';
...
function getSocketUrl() {
  const configured = process.env.NEXT_PUBLIC_SOCKET_URL as string | undefined;
